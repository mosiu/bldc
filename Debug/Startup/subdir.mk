...
Startup/%.o: ../Startup/%.S
	...
	"D:\DAVE-4.1.2\eclipse\ARM-GCC-49/bin/arm-none-eabi-gcc" -x assembler-with-cpp -DXMC4500_F100x1024 -I"D:\Naukowe\BLDC_workspace\PWM_from_ex\Libraries\XMCLib\inc" -I"D:\Naukowe\BLDC_workspace\PWM_from_ex" -I"D:\Naukowe\BLDC_workspace\PWM_from_ex\Dave\Generated" -Wall -Wa,-adhlns="$@.lst" -mfloat-abi=softfp -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d) $@" -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mthumb -g -gdwarf-2 -o "$@" "$<"
